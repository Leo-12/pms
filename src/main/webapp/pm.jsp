...
<title>用户管理</title>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/js/bootstrap/css/bootstrap.css">
...
<script type="text/javascript">
       $(function(){
	     ...
	     var setting = {
				async: {
					enable: true,
                    type:"GET",
					url:"${pageContext.request.contextPath}/sources/select",
       ...
       function editNode(id) {
       	   window.location.href = "${pageContext.request.contextPath}/sources/selectsource/"+id;
       }
       ...
       function deleteNode(id){
    	   layer.confirm("删除资源信息, 是否继续",  {icon: 3, title:'提示'}, function(cindex){
				...
				$.ajax({
					type : "POST",
					url  : "${pageContext.request.contextPath}/sources/deletesource",
