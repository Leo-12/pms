											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=regtxt title=请填写用户名 maxLength=16
														size=16 value="zsf123" name=username id=username></TD>
												</TR>
												<TR>
													<TD align=middle width=81><FONT color=#ffffff>密&nbsp;
															码：</FONT></TD>
													<TD><INPUT class=regtxt title=请填写密码 type=password
														maxLength=16 size=16 value="000000" name=password id=password></TD>
												</TR>
												<TR>
													<TD align=middle width=81><FONT color=#ffffff>验证码：</FONT></TD>
													<TD><INPUT class=regtxt title=请填写验证码 maxLength=50 size=16 name=code>
