...
<form name="form2" action="${pageContext.request.contextPath}/bx/insert" id="form9" method="post">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input id="usetime" size="32" name="bxtime"/>
		<img onclick="WdatePicker({el:'usetime',skin:'YcloudRed'})" src="${pageContext.request.contextPath}/static/js/My97DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle">
	</td>
</tr>
