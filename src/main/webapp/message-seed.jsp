...
<script type="text/javascript">
    $(function () {
        ...
        $.ajax({
			type:"get",
			url:"${pageContext.request.contextPath}/emp/recipient",
    ...
    $(function () {
        ...
        $.ajax({
			type:"post",
			url:"${pageContext.request.contextPath}/email/insert",
			success:function (msg) {
				if(msg.map.statusCode == 200){
				    window.location.href = "${pageContext.request.contextPath}/message.jsp";
				}
            }
		})
    })
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select name="ename" id="recipient-list">
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		...
		<img onclick="WdatePicker({el:'sendTime',skin:'YcloudRed',minDate:'%y-%M-{%d}'})" src="${pageContext.request.contextPath}/static/js/My97DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle">
	</td>
</tr>
